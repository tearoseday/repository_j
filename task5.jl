...
function inner_perimeter!(r::Robot)::Nothing
    a1=numsteps_along!(r, Sud)   #перемещается в юго-западный угол
    b1=numsteps_along!(r, West)
    a2=numsteps_along!(r, Sud)
    b2=numsteps_along!(r, West)
    
    perimeter!(r)   #маркировка внешней рамки
